...
RSpec.describe 'The Garden Show page' do
  before :each do
    ...
    @plant_3 = @plot_2.plants.create!(name: "Rutabega", description: "No one eats these.", days_to_harvest: 11)
    @plant_4 = @plot_2.plants.create!(name: "Tomato", description: "Not very good unless covered in mozarella.", days_to_harvest: 13)
    @plant_5 = @plot_3.plants.create!(name: "Basil", description: "Greatest thing on earth.", days_to_harvest: 10)
    @plant_6 = @plot_3.plants.create!(name: "Rutabega", description: "No one eats these", days_to_harvest: 11)
  ...
  it 'only displays unique plants that take less than 100 days to harvest' do
